const { startComparison } = require('./_startComparison')

class MultiComparisonWorker {
  constructor(db, bulkComparisonWorker) {
    this.db = db
    this.bulkComparisonWorker = bulkComparisonWorker
  }
...
exports.MultiComparisonWorker = MultiComparisonWorker
