...
const TOP_LIST: BulkTestParams[] =
  [
    { url: 'http://www.alibaba.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'http://www.condenast.com/', location: 'eu-central-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://diply.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'http://www.espn.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'http://fandom.wikia.com/explore', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.golem.de/', location: 'eu-central-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://imgur.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'http://www.kicker.de/', location: 'eu-central-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'http://www.molsoncoors.com/en', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'http://www.msn.com/de-de/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.realtor.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.reddit.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.theguardian.com/international', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.tumblr.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.walmart.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.yelp.com/sf', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.ebay.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.office.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'http://www.imdb.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.wellsfargo.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'http://www.breitbart.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.microsoft.com/en-us/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.upworthy.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.wsj.com/news/us', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.usatoday.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.booking.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
    { url: 'https://www.tripadvisor.com/', location: 'us-east-1-docker:Chrome.FIOSNoLatency', runs: 10, mobile: false },
