const { DEFAULT_LOCATION, DEFAULT_ACTIVITY_TIMEOUT } = require('./_testRequest');
 ...
 */
class MultiComparisonRequest {
  constructor(db, createdBy, params) {
    this.db = db
...
exports.MultiComparisonRequest = MultiComparisonRequest
