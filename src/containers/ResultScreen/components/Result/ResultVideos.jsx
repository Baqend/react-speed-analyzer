            ...
            <div className="video__wrapper-inner">
              <div className="relative">
                <video id="competitorVideo"
                  ...
                  src={competitorVideoPath && `https://${import.meta.env.VITE_REACT_APP_BAQEND}/v1${competitorVideoPath}`}/>
            ...
            <div className="video__wrapper-inner">
              <div className="relative">
                <video id="speedKitVideo"
                  ...
                  src={speedKitVideoPath && `https://${import.meta.env.VITE_REACT_APP_BAQEND}/v1${speedKitVideoPath}`}/>
