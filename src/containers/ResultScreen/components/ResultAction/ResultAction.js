...
import {
  ...
  categorizeCompressionFact,
  categorizeHTTPCachingFact,
  categorizeIOFact,
  categorizePWAFact,
  categorizeSSLFact,
  categorizeTtfbFact,
  categorizeUserPerceivedPerformanceFact,
...
class ResultAction extends Component {
  ...
  getCTAContent = () => {
    ...
    const {
      contentSize: competitorContentSize = { images: 50001, text: 50001 },
    } = competitorData;
    const { contentSize: speedKitContentSize = { images: 0, text: 0 } } =
      speedKitData;

    // Image Optimization
    categorizeIOFact(
      competitorContentSize,
      speedKitContentSize,
      isSpeedKitComparison,
      applied,
      improvements
  ...
  renderIsSpeedKitCta(speedKitVersion, configAnalysis) {
    const { configMissing, isDisabled, swPath, swPathMatches } =
      configAnalysis || {};
    ...
    const absolute = calculateAbsolute(
      competitorData[this.props.result.mainMetric],
      speedKitData[this.props.result.mainMetric]
    );
    ...
    return (
      <div>
        <div style={{ maxWidth: 768, margin: "0 auto" }}>
          <div className="text-center pb2 pt2">
            ...
            <span className="faded">
              The Analyzer detected Speed Kit version {speedKitVersion}. The
              test therefore compared your website with Speed Kit to a version
              where Speed Kit is not installed.
            </span>
            {configAnalysis && (
              <span className="faded">
                To help you integrating Speed Kit on your website, you can find
                the status of your installation below.
              </span>
            )}
          </div>
          {configAnalysis && (
            <div className="flex flex-wrap pb2">
              <div className="flex mt2">
                <div className="w-90">
                  <h3 className="mt0 mb0">
                    Secure your website with <strong>SSL</strong>
                  </h3>
                  <h4 className="faded mt0 mb0">
                    Since Speed Kit is built on Service Workers, it is only
                    available when SSL is turned on. Thereby a encrypted
                    communication for your website is enabled.
                  </h4>
                </div>
                <div className="w-10 text-center">
                  <FontAwesomeIcon
                    icon={isSecured ? faCheckCircle : faExclamationCircle}
              ...
              {!configAnalysis.configMissing && (
                <div className="flex mt2">
                  <div className="w-90">
                    <h3 className="mt0 mb0">
                      Host the <strong>Service Worker</strong> script in the
                      correct scope
                    </h3>
                    <h4 className="faded mt0 mb0">
                      The path of the Service Worker script specified in your
                      Speed Kit config has to match the path found by the
                      Analyzer.&nbsp;
                      {!swPath && (
                        <span>
                          There was no Service Worker found by the Analyzer.
                        </span>
                      )}
                      {!swPathMatches && swPath && (
                        <span>
                          The detected Service Worker path at{" "}
                          <strong>{swPath}</strong> does not match the specified
                          path.
                        </span>
                      )}
                    </h4>
              ...
              <div className="flex mt2">
                <div className="w-90">
                  <h3 className="mt0 mb0">
                    Provide an enabled <strong>Speed Kit config</strong> on your
                    website
                  </h3>
                  <h4 className="faded mt0 mb0">
                    Use the config in your website to enable and configure Speed
                    Kit. It needs to be included into your page.&nbsp;
                    {configMissing && (
                      <span>
                        Unfortunately, there was no Speed Kit config found on
                        your page.
                      </span>
                    )}
                    {!configMissing && isDisabled && (
                      <span>
                        The Speed Kit config found on your page is disabled. Set
                        attribute "disabled" to false to fix this issue.
                      </span>
                    )}
                  </h4>
                </div>
        ...
        {showOptimization ? (
          ...
          <div
            className="text-center pb2 pt2"
            style={{ maxWidth: 700, margin: "0 auto" }}
          >
            <h2 className="dn db-ns mb0">Optimizations</h2>
            <h3 className="dn-ns mb0">Optimizations</h3>
          </div>
        )}
        ...
        {this.props.toggleModal && (
          <div className="text-center">
            <a
              className="btn btn-purple btn-ghost ma1"
              ...
              <div className="flex ml2 mr2">
                <div className="w-20 w-10-ns">
                  <FontAwesomeIcon
                    ...
                    style={{ color: "#ff9d00", width: "30px", height: "30px" }}
                  />
                </div>
                <div className="w-80 w-90-ns">
                  <h4 className="mb0 mt0 fw6">{content[0]}</h4>
    ...
    return (
      <div>
        <div className="text-center pb3 pt6">
          <h2 className="mb0">
            Speed Kit Accelerates Your Website by{" "}
        ...
        {this.props.toggleModal && (
          <div className="text-center">
            <a
              ...
              href="https://www.baqend.com/speedkit.html?_ga=2.224276178.858004496.1520933148-181229276.1509025941#sk-features"
            >
              Learn more
            </a>
            <a
